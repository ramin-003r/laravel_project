                  ...
                  <li class="dropdown">
                      ...
                      <ul class="dropdown-menu extended tasks-bar">
                              ...
                              <a href="#">
                                  ...
                                  <div class="progress progress-striped">
                                      <div class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: 87%">
                                          <span class="sr-only">57% کامل</span>
                                      </div>
                                  </div>
                              </a>
                          </li>
                          <li>
                              <a href="#">
                                  <div class="task-info">
                                      <div class="desc"> Mobile application </div>
                                      <div class="percent">63%</div>
                                  </div>
                                  <div class="progress progress-striped">
                                      <div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100" style="width: 33%">
                                          <span class="sr-only">63% کامل (اخطار)</span>
                                      </div>
                                  </div>
                              </a>
                          </li>
                              ...
                              <a href="#">
                                  ...
                                  <div class="progress progress-striped active">
                                      <div class="progress-bar"  role="progressbar" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100" style="width: 45%">
                                          <span class="sr-only">85% کامل</span>
                                      </div>
                                  </div>
              ...
              <ul class="nav pull-right top-menu">
                  ...
                  <li class="dropdown">
                      ...
                      <ul class="dropdown-menu extended logout">
                          ...
                          <li><a href="login.html"><i class="icon-key"></i>Exit</a></li>
                      </ul>
                  </li>
    ...
    <div id="sidebar"  class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="sub-menu">
                ...
                <ul class="sub">
                    <li><a class="" href="{{ route('users.index') }}">لیست users </a></li>
                    <li><a class="" href="{{ route('users.create') }}"> اضافه کردن users </a></li>
                </ul>
            </li>
            <li class="sub-menu">
                <a href="javascript:;" class="">
                ...
                <ul class="sub">
                    <li><a class="" href="{{ route('categories.index')  }}">صفحه اصلی دسته بندی</a></li>
                </ul>
            </li>
            <li class="sub-menu">
                <a href="javascript:;" class="">
                ...
                <ul class="sub">
                    ...
                    <li><a class="" href="{{ route('posts.create') }}">ارسال پست</a></li>
                </ul>
            </li>
